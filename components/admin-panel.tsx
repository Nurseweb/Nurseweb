...
interface LoginModalProps {
  open: boolean
  onClose: () => void
  onSuccess: (user: { id: string; email: string; name: string; role: string }, token: string) => void
}
    ...
    <>
      <style>{`
        ...
        .field-input {
          ...
          color: #0d2b33; background: #f0f6f8; border: 1.5px solid transparent;
        ...
        .submit-btn {
          ...
          font-weight: 600; background: #0e7490; color: #fff; border: none;
          border-radius: 9px; padding: 13px; cursor: pointer;
        ...
        .close-btn {
          ...
          background: none; border: none; color: #8aacb4; cursor: pointer;
        ...
        .eye-btn {
          ...
          background: none; border: none; color: #8aacb4; cursor: pointer; padding: 2px;
          transition: color 0.2s ease;
        }
        .eye-btn:hover { color: #0e7490; }
        .forgot-link { font-size: 0.75rem; color: #8aacb4; text-decoration: none; transition: color 0.2s ease; }
      ...
      >
        <div
          ...
          style={{
            ...
            width: "100%", maxWidth: "400px", border: "1px solid #dce9ec",
          ...
          <div style={{ padding: "36px 36px 32px" }}>
            ...
            <div style={{ marginBottom: "28px" }}>
              <div style={{
                ...
                <svg width="20" height="20" viewBox="0 0 20 20" fill="none">
                  <path d="M10 2v16M5 7h10M3 13h14" stroke="#0e7490" strokeWidth="1.8" strokeLinecap="round" />
                </svg>
              </div>
              <h2 style={{
                fontFamily: "'Lora', Georgia, serif", fontSize: "1.5rem",
                fontWeight: 600, color: "#0d2b33", margin: "0 0 4px", letterSpacing: "-0.01em",
              }}>
                Нэвтрэх
              </h2>
            ...
            {error && (
              <div style={{
                ...
                color: "#b91c1c", marginBottom: "20px", textAlign: "center",
              }}>
                {error}
              </div>
            )}
            ...
            <form onSubmit={handleSubmit} style={{ display: "flex", flexDirection: "column", gap: "18px" }}>
              ...
              <div>
                <label style={{
                  ...
                  color: "#3d6672", marginBottom: "7px", letterSpacing: "0.02em",
                }}>
                  Имэйл хаяг
                </label>
                <input
              ...
              <div>
                <div style={{ display: "flex", alignItems: "center", justifyContent: "space-between", marginBottom: "7px" }}>
                  <label style={{ fontSize: "0.78rem", fontWeight: 600, color: "#3d6672", letterSpacing: "0.02em" }}>
                    Нууц үг
                  </label>
                  <a href="#" className="forgot-link">Нууц үг мартсан?</a>
                </div>
            ...
            <p style={{ textAlign: "center", fontSize: "0.73rem", color: "#a8c4cc", marginTop: "20px", lineHeight: 1.6 }}>
